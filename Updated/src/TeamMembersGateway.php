...
class TeamMembersGateway
{
    ...
    public function getAllData($teamId)
    {

        $sql = "SELECT tbl_team_assignment.teamid, tbl_team_assignment.empid, tbl_employees.firstname,

                tbl_employees.lastname, tbl_employees.position, tbl_employees.department, tbl_employees.image_filename

                FROM tbl_team_assignment

                LEFT OUTER JOIN tbl_employees

                ON tbl_team_assignment.empid = tbl_employees.empid
