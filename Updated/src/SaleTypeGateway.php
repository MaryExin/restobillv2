...
class SaleTypeGateway
{
    ...
    public function getAllData()
    {
        ...
        try {
            ...
            $sql = "SELECT * FROM lkp_sales_type Where deletestatus = 'Active' ORDER BY seq";
    ...
    public function getbyPageData($pageIndex, $pageData)
    {
        ...
        $sql = "SELECT * FROM lkp_sales_type Where deletestatus = 'Active' ORDER BY seq LIMIT $pageIndex, $pageData";
...
{
    $checkforduplisql = "SELECT COUNT(*) as count FROM lkp_sales_type WHERE description = :saletypedecriptions && deletestatus = 'Active'";
    ...
    if($rowCount > 0) {
        ...
        $sql = "INSERT INTO lkp_sales_type () VALUES (default, CONCAT('ST-',ShortUUID()), :saletypedecriptions, 'Active', :user_tracker, DATE_ADD(NOW(), INTERVAL 8 HOUR))";
        $stmt = $this->conn->prepare($sql);
    ...
    public function getInfiniteReadData($page, $pageIndex, $pageData, $search)
    {
        ...
        $sql = "SELECT * FROM lkp_sales_type Where deletestatus = 'Active' AND description LIKE :search ORDER BY seq LIMIT $pageIndex, $pageData";
