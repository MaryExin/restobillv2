        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                // $otid = join($otcode);
                        ...
                        $rows = $this->gateway->rejectot($this->user_id,$data);
                        // echo json_encode(["message" => "Sales Type deleted", "rows" => $rows]);

                exit;
                } else{
                        $rows = $this->gateway->editot($this->user_id,$data);
                        // echo json_encode(["message" => "Sales Type Edit", "rows" => $rows]);
                }
            } else {
