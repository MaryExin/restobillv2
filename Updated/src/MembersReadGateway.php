...
class MembersReadGateway
{
    ...
    {
        $sql = "SELECT uuid, firstname, lastname, status, company, department, contactnumber from tbl_users_global_assignment LIMIT $pageIndex, $pageData";
