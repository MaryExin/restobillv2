...
class ItempricingGateway
{
    ...
    if($rowCount > 0) {
        ...
        $sql = "INSERT INTO lkp_pricing_code ()
                ...
                VALUES (default, CONCAT('PC-',ShortUUID()),:pricing_code, 'Active', :user_tracker, DATE_ADD(NOW(), INTERVAL 8 HOUR))";
    ...
    {
$checkforduplisql = "SELECT COUNT(*) as count FROM lkp_pricing_code WHERE pricing_code = :productcatdesc && deletestatus = 'Active'";
    $checkforduplistmt = $this->conn->prepare($checkforduplisql);
