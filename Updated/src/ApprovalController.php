...

{
    ...
    public function processTransactionApproval(string $method, $data): void
    
    {
             ...
             if ($method == "GET") {
                ...
                $this->gateway->approveTransaction($this->user_id, $data);
...

    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                echo json_encode($this->gateway->getCreditByBusUnit($data));
    ...
    public function processReadCrediSalesInvoice(string $method, $data): void
...

    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                echo json_encode($this->gateway->getSalesInvoice($data));
...

    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                echo json_encode($this->gateway->getApprovalSummary($this->user_id, $data));
    ...
    public function processFixedAssetsApproval(string $method, $data): void
    
    {
             ...
             if ($method == "GET") {
                ...
                $this->gateway->approveFixedAsset($this->user_id, $data);
