...
class UsermanyrolesGateway
{
    ...
    public function getAllData()
    {
        ...
        try {
            ...
            $sql = "SELECT * FROM tbl_user_roles Where deletestatus = 'Active' ORDER BY userid";
    ...
    public function getbyPageData($pageIndex, $pageData)
    {
        ...
        // $sql = "SELECT * FROM tbl_user_roles Where deletestatus = 'Active' ORDER BY userid  LIMIT $pageIndex, $pageData";
        ...
        $sql = "SELECT
                ...
                tbl_user_roles
                    LEFT OUTER JOIN
                tbl_users_global_assignment ON tbl_user_roles.userid = tbl_users_global_assignment.uuid
                ORDER BY firstname
