...
class SalesSearchSummaryGateway
{
    ...
    public function getbyPageData($pageIndex, $pageData, $field, $searchParams)
    {

        // SQL query with placeholders
        $sql = "SELECT * FROM tbl_sales_history
        WHERE $field LIKE CONCAT(:searchParams, '%') 
        ORDER BY seq DESC
        ...
        // Bind parameters
        $stmt->bindParam(':searchParams', $searchParams, PDO::PARAM_STR);
