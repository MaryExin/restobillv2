    ...
    public function processRequest(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                // $areaid = join($areacode);

                        $rows = $this->gateway->rejectacctgtransmap($this->user_id,$data);
                        // echo json_encode(["message" => "Area deleted", "rows" => $rows]);

                exit;
                } else{
                        $rows = $this->gateway->editacctgtransmap($this->user_id,$data);
                        // echo json_encode(["message" => "Area Edit", "rows" => $rows]);
                }
            } else {
