...
class TasksGateway
{
    ...
    public function getbyPageData($pageIndex, $pageData)
    {
        ...
        $sql = "SELECT * FROM tbl_tasks ORDER BY seq DESC LIMIT $pageIndex, $pageData";
    ...
    public function createForUser($user_id, $taskname)
    {
        ...
        $sql = "INSERT INTO tbl_tasks ()
                ...
                VALUES (default, ShortUUID(),:taskname, 'Active', :user_tracker, DATE_ADD(NOW(), INTERVAL 8 HOUR))";
        ...
        echo json_encode(["message" => "taskNameSuccess"]);
