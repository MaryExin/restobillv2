...
if (!array_key_exists("empid", $data) || !array_key_exists("teamid", $data)) {
...
$gateway = new TeamAssignmentGateway($database);

//Initialize Task Controller to process API Requests

$controller = new TeamAssignmentController($gateway, $user_id);
