...
$pageData = 10; // Adjust the page size as needed
...
$gateway = new SalesDataGateway($database);

//Initialize Task Controller to process API Requests

$controller = new SalesDataController($gateway, $user_id);

$controller->processInfiniteRequest($_SERVER['REQUEST_METHOD'], $page, $pageIndex, $pageData);
