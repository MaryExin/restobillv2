    ...
    if ($fileType === 'text/csv' || $fileType === 'application/vnd.ms-excel') {
        ...
        try {
            ...
            while (($data = fgetcsv($handle, 1000, ",")) !== false) {
                ...
                $stmt = $pdo->prepare("INSERT INTO tbl_sales_history (uuid, area, month, year, gross_sales, usertracker, createtime)
                VALUES (uuid(), :area, :month, :year, :gross_sales, :userid, now())");
