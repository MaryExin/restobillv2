...
$gateway = new CashieringReportGateway($database);

//Initialize Task Controller to process API Requests

$controller = new CashieringReportController($gateway, $user_id);

$controller->processOtherMopSummaryRequest($_SERVER['REQUEST_METHOD'], $data);
