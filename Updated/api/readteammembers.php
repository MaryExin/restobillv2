...
$gateway = new TeamMembersGateway($database);

//Initialize Task Controller to process API Requests

$controller = new TeamMembersController($gateway, $user_id);

$controller->processQueryRequest($_SERVER['REQUEST_METHOD'], $teamId);
