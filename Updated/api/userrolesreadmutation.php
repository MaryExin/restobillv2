...
$userRolesReadGateway = new UserRolesReadGateway($database);

//Initialize Task Controller to process API Requests
$controller = new UserRolesReadController($userRolesReadGateway, $user_id);

$controller->processRequest($_SERVER['REQUEST_METHOD'], $pageIndex, $pageData);
