...
$gateway = new PrChargeDeductionGateway($database);

//Initialize Task Controller to process API Requests

$controller = new PrChargeDeductionController($gateway, $user_id);

$controller->processviewRequest($_SERVER['REQUEST_METHOD'], $data);
