...
$gateway = new PosNewTransactionGateway($database);

//Initialize Task Controller to process API Requests

$controller = new PosNewTransactionController($gateway, $user_id);

$controller->processRequest($_SERVER['REQUEST_METHOD'], $page, $pageIndex, $pageData, $search);
