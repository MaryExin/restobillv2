...
$pageData = 100; // Adjust the page size as needed
...
$gateway = new TutorialsGateway($database);

//Initialize Task Controller to process API Requests

$controller = new TutorialsController($gateway, "Exinnov");

$controller->processInfiniteRequest($_SERVER['REQUEST_METHOD'], $page, $pageIndex, $pageData, $search);
