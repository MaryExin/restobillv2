...
$emailContent = "<html>
        ...
        <div class='email-container'>
            ...
            <div class='email-body'>
                ...
                <p>
                    ...
                    <strong>*Exinnov products that  you are interested in:*</strong> {$data["ExinnovProducts"]}<br>
                </p>
                ...
                <p>Exinnovadmin@Exinnovph.com</p>
                <p>Exinnov.com.ph</p>
    ...
    $emailController->sendEmail(
        ...
        "admin@exinnovph.com",
        $data["email"],
        "Exinnov Partnership - Exinnov Business Solution",
        $emailContent
    );
...
$emaiBoardlContent = "<html>
        ...
        <div class='email-container'>
            ...
            <div class='email-body'>
                ...
                <p>
                    ...
                    <strong>*Address:*</strong> {$data["address"]}<br>
                    <strong>*Gender:*</strong> {$data["gender"]}<br>
                    <strong>*Exinnov products that interested in:*</strong> {$data["ExinnovProducts"]}<br>
                </p>
            </div>
 ...
 $cc = ['maryExinnov@gmail.com', 'charliebpanao12@gmail.com' , 'delacruzjennelyn15@gmail.com' ,'jeremiah.richwell@outlook.com'];
    ...
    $sql = "INSERT INTO tbl_partnership (
        ...
        Exinnov_products, deletestatus, createdtime
    ) VALUES (
        CONCAT('PR-', ShortUUID()), :fullname, :profession, :company_name, :target_industry, 
        :count_of_target_clients, :contact_no, :email, :address, :gender, 
        :Exinnov_products, 'Active', DATE_ADD(NOW(), INTERVAL 8 HOUR)
    )";
    ...
    $stmt->bindValue(":Exinnov_products", $data["ExinnovProducts"], PDO::PARAM_STR);
