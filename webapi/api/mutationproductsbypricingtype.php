...
$gateway = new ProductsByPricingTypeGateway($database);

//Initialize Task Controller to process API Requests

$controller = new ProductsByPricingTypeController($gateway, $user_id);



$controller->fetchProductsByPricingType($_SERVER['REQUEST_METHOD'], $data);
