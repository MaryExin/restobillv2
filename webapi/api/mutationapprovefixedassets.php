...
$gateway = new ApprovalGateway($database);
...
$controller = new ApprovalController($gateway, $user_id);



$controller->processFixedAssetsApproval($_SERVER['REQUEST_METHOD'], $data);
