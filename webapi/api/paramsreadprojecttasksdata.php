...
$gateway = new ProjectSetupGateway($database);

//Initialize Task Controller to process API Requests

$controller = new ProjectSetupController($gateway, $user_id);

$controller->processQueryProjectTaskRequest($_SERVER['REQUEST_METHOD']);
