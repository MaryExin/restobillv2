...
$gateway = new EditCostsInOrderSummaryGateway($database);

//Initialize Task Controller to process API Requests

$controller = new EditCostsInOrderSummaryController($gateway, $user_id);

$controller->processPatchRequest($_SERVER['REQUEST_METHOD'], $data);
