...
$gateway = new DeliveryDetailsGateway($database);

//Initialize Task Controller to process API Requests

$controller = new DeliveryDetailsController($gateway, $user_id);

$controller->processShippingAssignmentEditRequest($_SERVER['REQUEST_METHOD'], $data);
