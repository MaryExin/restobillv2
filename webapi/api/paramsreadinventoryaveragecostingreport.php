...
$gateway = new InventoryAverageCostingReportGateway($database);

//Initialize Task Controller to process API Requests

$controller = new InventoryAverageCostingReportController($gateway, $user_id);

$controller->processQueryRequest($_SERVER['REQUEST_METHOD']);
