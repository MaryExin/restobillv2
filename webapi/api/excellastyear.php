...
$gateway = new LastYearGateway($database);

//Initialize Task Controller to process API Requests

$anonUser = "none";

$controller = new LastYearController($gateway, $anonUser);

$controller->processExcelReadData($_SERVER['REQUEST_METHOD'], $busunitCode);
