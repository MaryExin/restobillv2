...
$gateway = new ChartOfAccountsGateway($database);

//Initialize Task Controller to process API Requests

$controller = new ChartOfAccountsController($gateway, $user_id);

$controller->processDistinctRequest($_SERVER['REQUEST_METHOD']);
