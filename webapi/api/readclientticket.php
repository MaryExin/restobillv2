...
$gateway = new TicketGateway($database);

//Initialize Task Controller to process API Requests

$controller = new TicketController($gateway, $user_id);

$controller->processInfiniteRequest($_SERVER['REQUEST_METHOD'], $page, $pageIndex, $pageData, $search,$busunitcode,$status);
