...
$gateway = new GovtDeductionsGateway($database);

//Initialize Task Controller to process API Requests

$anonUser = "none";

$controller = new GovtDeductionsController($gateway, $anonUser);

$controller->processExcelPhicReadData($_SERVER['REQUEST_METHOD'], $busunitCode, $dateFrom, $dateTo);
