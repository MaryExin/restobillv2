...

    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                $pricecode = $data["pricing_code"];

                $priceid = join($pricecode);



                        $rows = $this->gateway->rejectprices($this->user_id,$priceid);

                        // echo json_encode(["message" => "Price deleted", "rows" => $rows]);
                ...
                exit;
                        ...
                        $rows = $this->gateway->editprice($this->user_id,$data);

                        // echo json_encode(["message" => "Price Edit", "rows" => $rows]);
            ...
            switch ($method) {
                ...
                case "PATCH":
                        ...
                        $pricecode = $data["brand_code"];



                        $rows = $this->gateway->rejectprices($data);
