...
class BuildComponentsController
{
    /**
    ...
    public function processRequestReadActualComponents(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                echo json_encode($this->gateway->getDataByActualComponents($data));
    ...
    public function processFilteredByIdRequest(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                echo json_encode($this->gateway->getAllDataWithNamesbyId($data));
    ...
    public function processQueryWithNames(string $method): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                echo json_encode($this->gateway->getAllDataWithNames());
