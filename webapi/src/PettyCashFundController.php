    ...
    public function processRequest(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                $rows = $this->gateway->deletePCFItem($this->user_id, $data);

                echo json_encode(["message" => "Success", "rows" => $rows]);
    ...
    public function processQueryRequest(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                echo json_encode($this->gateway->getPCFDataToday($this->user_id, $data));
