...

{
...

    {
        ...
        $sql = "SELECT 
                    ...
                    ROUND((IFNULL(t2.net_sales, 0) - IFNULL(t2.total_other_mop, 0)  + IFNULL(t4.amount_cleared * -1, 0)),

                            2) AS cash_for_deposit,

                    IFNULL(t3.pcf_charges, 0) AS pcf_charges,

                    ROUND((IFNULL(t2.net_sales, 0)  + IFNULL(t2.total_vat, 0) - IFNULL(t2.total_other_mop, 0) - IFNULL(t3.pcf_charges, 0) + IFNULL(t4.amount_cleared * -1, 0)),
                    ...
                    tbl_cash_sales_summary_tracker.variance,
                  	...
                  	IFNULL(t4.amount_cleared * -1, 0) AS amount_cleared
                ...
                FROM
                    ...
                    (SELECT 
                        ...
                        clearing_reference, SUM( IFNULL(amount_cleared, 0)) AS amount_cleared, tbl_sales_summary.cash_trans_id
                    ...
                    AND tbl_credit_sales_clearing.payment_type = 'CASH'

                    GROUP BY clearing_reference) t4 ON tbl_cash_sales_summary_tracker.cash_trans_id = t4.cash_trans_id
