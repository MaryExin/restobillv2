...
class ItemsGateway
{
    ...
    public function getAllStockItemsData()
    {
        ...
        try {
            ...
            $sql = "SELECT build_code as build_code, `desc`, level, uomval, uom, deletestatus FROM lkp_build_of_products UNION SELECT mat_code as build_code, `desc`, level, uomval ,uom ,deletestatus FROM lkp_raw_mats Where lkp_raw_mats.deletestatus = 'Active' ORDER BY `desc`";
