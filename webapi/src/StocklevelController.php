        ...
        if (true) {
            if ($method == "GET") {
                ...
                if (!array_key_exists("edit", $data)) {
                        ...
                        $rows = $this->gateway->rejectstocklevels($this->user_id,$data);
                        // echo json_encode(["message" => "stocklevel deleted", "rows" => $rows]);
                exit;

                } else{
                        $rows = $this->gateway->editstocklevel($this->user_id,$data);
                        // echo json_encode(["message" => "stocklevel Edit", "rows" => $rows]);
                }
            ...
            switch ($method) {
                ...
                case "PATCH":
                        ...
                        $stocklevelcode = $data["brand_code"];



                        $rows = $this->gateway->rejectstocklevels($data);
