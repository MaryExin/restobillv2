...
class DepositClearingGateway
{
    ...
    public function getInfiniteReadDataprint($user_id,$data)
    {
        ...
        $sql = "SELECT 
                    transdate,
                    lkp_busunits.name,
                    depositary_bank_desc,
                    deposit_reference,
                    (cash_count - cash_opening_balance) AS cash_deposit,
                    lkp_busunits.name
                FROM
                ...
                WHERE
                    deposit_reference = :reference
                        AND depositary_bank_desc = :depositary_bank_desc
    ...
    public function clearForUser($user_id, $data)
    {
        try {
            ...
            VALUES (default, 'Exinnov', :busunitcode, 'Deposit', 'Deposit Clearing', :particulars, :id, 'Active', DATE_ADD(NOW(), INTERVAL 8 HOUR))";
