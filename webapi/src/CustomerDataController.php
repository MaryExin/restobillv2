...

{
...

    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
              ...
              $this->gateway->editCustomerDetails($this->user_id, $data);
    ...
    public function processDeleteRequest(string $method, $data): void

    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
              ...
              $this->gateway->deleteCustomerDetails($this->user_id, $data);
    ...
    public function processExcelReadData(string $method): void

    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                echo json_encode($this->gateway->ExcelGetCustomers());
