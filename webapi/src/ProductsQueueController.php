...
class ProductsQueueController
{
    ...
    public function processDeliveryRequest(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                $this->gateway->deliveryDetails($this->user_id, $data);
    ...
    public function processSpoilage(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                $this->gateway->createSpoilage($this->user_id, $data, $shortUuid);
    ...
    public function processTransfer(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                $this->gateway->createTransfer($this->user_id, $data, $shortUuid);
    ...
    public function processRequestNewPr(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                $this->gateway->createNewPr($this->user_id, $data);

            } elseif ($method == "PATCH") {

                $this->gateway->updatesupplier($this->user_id, $data);
