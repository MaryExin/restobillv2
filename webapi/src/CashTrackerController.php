...
class CashTrackerController
{
    ...
    public function processOpening(string $method, $data): void
    {

        if (true) {

            if ($method == "GET") {
                echo json_encode($this->gateway->getAllData($page, $pageIndex, $pageData, $search,  $busunitcode));
            } elseif ($method == "POST") {

                $this->gateway->getCashOpening($this->user_id, $data);
    ...
    public function processClosing(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                $this->gateway->getCashClosing($this->user_id, $data);
    ...
    public function processPendingSales(string $method): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                echo json_encode($this->gateway->getPendingSales());
    ...
    public function getDataPendingSales(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                echo json_encode($this->gateway->getPendingSalesFigures($data));
    ...
    public function processQueryRequest(string $method, $user_id): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                echo json_encode($this->gateway->getForUser($user_id));
