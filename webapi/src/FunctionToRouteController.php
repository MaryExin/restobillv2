...
class FunctionToRouteController
{
    /**
    ...
    public function processInfiniteRequest(string $method, $page, $pageIndex, $pageData): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                echo json_encode($this->gateway->getInfiniteData($page, $pageIndex, $pageData));
