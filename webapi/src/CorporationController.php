    ...
    public function processRequest(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                $corpid = join($corpcode);

                        $rows = $this->gateway->rejectcorps($this->user_id, $corpid);
                        // echo json_encode(["message" => "Corp deleted", "rows" => $rows]);

                exit;
                } else{
                        $rows = $this->gateway->editcorp($this->user_id, $data);
                        // echo json_encode(["message" => "Corp Edit", "rows" => $rows]);
                }
            } else {
        ...
        public function processExcelReadData(string $method): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                echo json_encode($this->gateway->ExcelGetCorporations());
