...
class EmployeeDataGateway
{
    ...
    public function getAllData()
    {
        ...
        $sql = "SELECT
                ...
                tbl_employees.department, tbl_employees.busunit_code, lkp_busunits.name,  tbl_employees.email
                ...
                tbl_employees
					...
					LEFT OUTER JOIN lkp_busunits ON tbl_employees.busunit_code = lkp_busunits.busunitcode
                ...
                tbl_customer_details.customer_id, tbl_customer_details.customername, 
                tbl_customer_details.branchname, 'NA', 'NA', tbl_customer_details.email
