...
class DisbursementsController
{
    ...
    public function processReadInfiniteMultipleClearingItems(string $method, $page, $pageIndex, $pageData, $search, $min, $max, $busunitcode): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                echo json_encode($this->gateway->getMultipleClearingItems($this->user_id,$page, $pageIndex, $pageData, $search, $min, $max, $busunitcode));
    ...
    public function processReadInfiniteClearingItems(string $method, $page, $pageIndex, $pageData, $search, $min, $max, $busunitcode): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                echo json_encode($this->gateway->getClearingItems($page, $pageIndex, $pageData, $search, $min, $max, $busunitcode));
    ...
    public function processInfiniteRequest(string $method, $page, $pageIndex, $pageData, $search, $busunitcode = ""): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                echo json_encode($this->gateway->getInfiniteData($page, $pageIndex, $pageData, $search, $busunitcode));
    ...
    public function processMultipleClearing(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                $this->gateway->multipleClearing($this->user_id, $data);
    ...
    public function processAllDisbursementsRequest(
    string $method,
    $page,
    $pageIndex,
    $pageData,
    ...
    if ($method === "GET") {
        echo json_encode(
            $this->gateway->getAllDisbursementItems(
                $page,
                $pageIndex,
                $pageData,
                $search,
