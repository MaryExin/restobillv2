...
class UserRoleController
{
    ...
    {
        // ✅ Keep your existing structure, just add the subscription action
        if (true) {

            if ($method == "GET") {

                // NOTE: your gateway in snippets did not include getAllData(),
                // but you already use it here in your actual project.
