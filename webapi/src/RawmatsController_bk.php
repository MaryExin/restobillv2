...
class RawmatsController
{
    ...
    public function processRequest(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                $rawmatsid = join($rawmatscode);

                        $rows = $this->gateway->rejectrawmatss($this->user_id,$rawmatsid);
                        // echo json_encode(["message" => "Rawmats deleted", "rows" => $rows]);

                exit;
            } else{
                        $rows = $this->gateway->editrawmats($this->user_id,$data);
                        // echo json_encode(["message" => "Rawmats Edit", "rows" => $rows]);
                }
            } else {
    ...
    public function processRawmats(string $method, $page, $pageIndex, $pageData, $search): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                echo json_encode($this->gateway->getRawmatsData($page, $pageIndex, $pageData, $search));
