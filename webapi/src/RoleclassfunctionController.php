...
class RoleclassfunctionController
{
    /**
    ...
    public function processRequest(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                $roleclassfunctioncode = $data["roleclassfunc_code"];
                $roleclassfunctionid = join($roleclassfunctioncode);

                        $rows = $this->gateway->rejectroleclassfunctions($this->user_id,$roleclassfunctionid);
                        // echo json_encode(["message" => "Role Class Function deleted", "rows" => $rows]);

                exit;
                } else{
                        $rows = $this->gateway->editroleclassfunction($this->user_id,$data);
                        // echo json_encode(["message" => "Role Class Function Edit", "rows" => $rows]);
                }
            } else {
