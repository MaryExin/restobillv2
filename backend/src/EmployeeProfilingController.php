...
class EmployeeProfilingController
{
    ...
    public function processReadSchedRequest(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                echo json_encode($this->gateway->getSchedForEmployee($data));
    ...
    public function processReadActualLogsRequest(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                echo json_encode($this->gateway->getActualLogsForEmployee($data));
    ...
    public function processReadPayslipRequest(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                echo json_encode($this->gateway->getPayslipForEmployee($data));
