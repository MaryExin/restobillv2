...
class COAGateway
{
    ...
    public function rejectcoas($user_id, string $id)
    {
 ...
 echo json_encode(["message" => "Deleted"]);
    ...
    public function editcoa($user_id, $id)
    {
        ...
        $stmt->bindValue(":id", $id["coa_code"], PDO::PARAM_STR);
    ...
    public function getInfiniteReadData($page, $pageIndex, $pageData, $search)
    {
        ...
        $sql = "SELECT * FROM lkp_chart_of_accounts Where deletestatus = 'Active' AND sl_description LIKE :search ORDER BY seq LIMIT $pageIndex, $pageData";
