...
class FunctionToRouteGateway
{
    ...
    public function getAllData()
    {
        ...
        $sql = "SELECT * FROM lkp_role_function_to_route_map
    ...
    public function getInfiniteData($page, $pageIndex, $pageData)
    {

        $sql = "SELECT * FROM tbl_sales_history ORDER BY seq DESC LIMIT $pageIndex, $pageData";
