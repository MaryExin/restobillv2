    ...
    public function processRequest(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                $productcategorycode = $data["productcatcode"];
                $productcategoryid = join($productcategorycode);

                        $rows = $this->gateway->rejectproductcategory($this->user_id,$productcategoryid);
                        // echo json_encode(["message" => "Product Category deleted", "rows" => $rows]);

                exit;
                } else{
                        $rows = $this->gateway->editproductcategory($this->user_id,$data);
