...
class DeliveryDetailsController
{
    ...
    public function processRequest(string $method, $data): void
    {
        ...
        if (true) {
         ...
         public function processReadNetDeliveryQty(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                echo json_encode($this->gateway->getNetDeliveryItems($data));
    ...
    public function processQueryRequest(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                echo json_encode($this->gateway->getShippingData($data));
    ...
    public function processEditRequestSupplier(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                if ($data["level"] === "SUPPLIER") {
                    $this->gateway->updateForUserSupplier($this->user_id, $data);
                } else {
                    $this->gateway->updateForUserDepartment($this->user_id, $data);
    ...
    public function processShippingDetailsEditRequest(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                $this->gateway->updateShippingDetailsForUser($this->user_id, $data);
    ...
    public function processShippingAssignmentEditRequest(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                $this->gateway->updateShippingAssignmentForUser($this->user_id, $data);
