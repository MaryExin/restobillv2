...
class ItemsController
{
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                if (!array_key_exists("edit", $data)) {
                    ...
                    $employeepositioncode = $data["empposition_code"];

                    $employeepositionid = join($employeepositioncode);

                    $rows = $this->gateway->rejectemployeepositions($this->user_id, $employeepositionid);

                    echo json_encode(["message" => "Employee Position deleted", "rows" => $rows]);

                    exit;

                } else {

                    $rows = $this->gateway->editemployeeposition($this->user_id, $data);

                    echo json_encode(["message" => "Employee Position Edit", "rows" => $rows]);
    ...
    public function processStockItemsRequest(string $method, $data): void
    {
        ...
        if (true) {
            ...
            if ($method == "GET") {
                ...
                echo json_encode($this->gateway->getAllStockItemsData());
