...
class SalesPackageGateway
{
    ...
    public function getPackageSalesData()
    {

        $sql = "SELECT 
                    tbl_sales_package_map.packageid,
                    tbl_sales_package_map.buildcode,
                    tbl_sales_package_map.discountpercentage,
                    lkp_package.package_name AS packagename
                FROM
                    tbl_sales_package_map
                    LEFT OUTER JOIN lkp_package ON tbl_sales_package_map.packagename = lkp_package.package_code
                WHERE
                    tbl_sales_package_map.deletestatus = 'Active'";
        $stmt = $this->conn->prepare($sql);
