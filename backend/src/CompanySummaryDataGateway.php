...
class CompanySummaryDataGateway
{
    ...
    public function getAllData()
    {
        ...
        $sql = "SELECT * FROM tbl_company_summary ORDER BY createtime DESC";
    ...
    public function getbyPageData($pageIndex, $pageData)
    {
        ...
        $sql = "SELECT * FROM tbl_company_summary ORDER BY createtime DESC LIMIT $pageIndex, $pageData";
    ...
    public function deletedataWithIds($ids)
    {
        ...
        foreach ($ids as $id) {
            ...
            $sql = "DELETE FROM tbl_company_summary
