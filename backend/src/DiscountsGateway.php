...
class DiscountsGateway
{
    ...
    public function getAllData()
    {
        ...
        $sql = "SELECT * FROM lkp_discounts WHERE deletestatus = 'Active' ORDER BY description ASC";
    ...
    public function getAllDataByBusunit($data)
    {

        $sql = "SELECT * FROM lkp_discounts   WHERE deletestatus = 'Active'
