...
if (!array_key_exists("build_code", $data) || !array_key_exists("mat_code", $data)) {
...
$gateway = new CreateBuild_MaterialsGateway($database);

//Initialize Task Controller to process API Requests

$controller = new CreateBuild_MaterialsController($gateway, $user_id);
