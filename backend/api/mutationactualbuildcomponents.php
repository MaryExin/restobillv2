...
$gateway = new BuildComponentsGateway($database);

//Initialize Task Controller to process API Requests

$controller = new BuildComponentsController($gateway, $user_id);

$controller->processRequestReadActualComponents($_SERVER['REQUEST_METHOD'], $data);
