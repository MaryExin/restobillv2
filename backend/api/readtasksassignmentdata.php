...
$gateway = new TaskAssignmentGateway($database);

//Initialize Task Controller to process API Requests

$controller = new TaskAssignmentController($gateway, $user_id);

$controller->processReadRequest($_SERVER['REQUEST_METHOD'], $pageIndex, $pageData, $empId);
