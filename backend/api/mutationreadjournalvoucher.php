...
$gateway = new JournalVoucherGateway($database);
...
$controller = new JournalVoucherController($gateway, $user_id);
...
$controller->processDisbursementVoucherDetails($_SERVER['REQUEST_METHOD'], $data);
