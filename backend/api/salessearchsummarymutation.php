...
$gateway = new SalesSearchSummaryGateway($database);

//Initialize Task Controller to process API Requests

$controller = new SalesSearchSummaryController($gateway, $user_id);

$controller->processRequest($_SERVER['REQUEST_METHOD'], $pageIndex, $pageData, $field, $searchParams);
