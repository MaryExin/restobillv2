...
$gateway = new TransactiontypesetupGateway($database);

//Initialize Task Controller to process API Requests

$controller = new TransactiontypesetupController($gateway, $user_id);

$controller->processRead($_SERVER['REQUEST_METHOD']);
