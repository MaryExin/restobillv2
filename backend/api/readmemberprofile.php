...
$gateway = new MemberProfileGateway($database);

//Initialize Task Controller to process API Requests

$controller = new MemberProfileController($gateway, $user_id);

$controller->processQueryRequest($_SERVER['REQUEST_METHOD'], $empId);
