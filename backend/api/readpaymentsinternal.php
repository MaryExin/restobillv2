...
$gateway = new PaymentsInternalGateway($database);

//Initialize Task Controller to process API Requests

$controller = new PaymentsInternalController($gateway, $user_id);

$controller->processReadRequest($_SERVER['REQUEST_METHOD'], $data);
