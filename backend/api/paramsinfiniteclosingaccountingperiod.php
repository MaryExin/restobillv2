...
$gateway = new ClosingAccountingPeriodGateway($database);
...
$controller = new ClosingAccountingPeriodController($gateway, $user_id);



$controller->processReadInfiniteClearingItems($_SERVER['REQUEST_METHOD'], $page,  $search,  $busunitcode);
