...
const PosReports = ({ open, onClose }) => {
  ...
  return createPortal(
    <>
      ...
      >
        <div
          className={`relative flex w-full max-w-[980px] flex-col overflow-hidden rounded-[30px] border shadow-[0_30px_100px_rgba(15,23,42,0.18)] ${
            isDark
        ...
        >
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                >
                  Select a report to view sales, transactions, and analytics.
                </p>
              </div>
          ...
          <div
            className={`flex justify-end border-t px-6 py-5 sm:px-8 ${
              isDark
          ...
          >
            <button
              ...
              className={`rounded-2xl px-5 py-3 text-sm font-semibold transition ${
                isDark
                  ? "bg-white/[0.06] text-slate-200 hover:bg-rose-500 hover:text-white"
