...
const ModalYesNo = ({
  ...
  const handleYes = () => {
    approveOrRejectMember(memberId);
    setModalOpen(false);
  };
  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <div className="bg-white rounded-2xl overflow-hidden w-11/12 max-w-lg">
            ...
            <div className="pt-20 pb-6 px-6 text-center space-y-4">
              ...
              <div className="flex justify-center gap-4 mt-4">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="inline-flex items-center px-6 py-2 bg-green-600 hover:bg-green-700 text-white font-medium rounded-full shadow-lg transition"
                >
                  Yes
                </motion.button>
                <motion.button
