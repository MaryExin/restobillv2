        ...
        <div className="flex flex-row justify-center p-5 h-screen z-20 bg-opacity-100">
          <div className="flex flex-col justify-start w-full md:w-1/2">
            <div className="flex flex-col mt-20 h-auto pb-5 shadow-2xl rounded-xl bg-white z-20">
              <div className="flex flex-row justify-center text-white w-full   bg-gradient-to-br from-darkerPrimary to-darkPrimary rounded-t-xl p-10">
                <motion.div
              ...
              <div className="flex flex-col space-y-5 py-5">
                ...
                <div className="flex flex-row justify-center space-x-3">
                  <a
                    className="shadow-md cursor-pointer shadow-zinc-500 w-32 text-center transition-all duration-150 bg-green-700 text-white border-b-8 border-b-green-700 rounded-lg hover:border-t-8 hover:border-b-0 hover:bg-green-700 hover:border-t-green-700 hover:shadow-lg"
                    onClick={() => {
                      triggerYesNoEvent();
                      setYesNoModalOpen(false);
                    }}
                  >
                    <div className="hover:shadow-md hover:shadow-zinc-500 p-5 duration-150  bg-darkerPrimary  rounded-lg hover:bg-green-700">
                      Yes
                    </div>
                  </a>
                  <a
...
export default ModalYesNoUpload;
