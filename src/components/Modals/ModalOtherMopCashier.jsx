...
const ModalOtherMopCashier = ({
  setIsModalOtherMopCashier,
  cashTransId,
  setTransId,
}) => {
  ...
  const {
    data: otherMopSummaryData,
    isLoading: otherMopSummaryDataIsLoading,
    isError: otherMopSummaryDataIsError,
    isSuccess: otherMopSummaryDataIsSuccess,
    mutate: otherMopSummaryDataMutate,
  } = useSecuredMutation(
    localStorage.getItem("apiendpoint") +
      import.meta.env.VITE_MUTATE_READ_CASHIERING_OTHERMOP_REPORT,
    "POST"
  );

  useEffect(() => {
    if (cashTransId !== "") {
      otherMopSummaryDataMutate({
          ...
          <div className="flex flex-col justify-center w-full md:w-1/2">
            <div className="scale-90 lg:scale-100  flex flex-col lg:mt-5 h-auto pb-5 shadow-2xl  overflow-y-auto scrollbar rounded-xl bg-slate-50 z-20">
              <div className="flex flex-row py-6 relative justify-center text-white w-full  bg-gradient-to-br from-darkerPrimary via-darkPrimary  to-medPrimary rounded-t-xl p-5">
                ...
                <div
                  onClick={() => {
                    setTransId(0, setIsModalOtherMopCashier(false));
                  }}
                ...
                <div className="flex flex-col font-semibold text-zinc-600  cursor-pointer">
                  ...
                  <div className="flex flex-row mb-2 border-b">
                    ...
                    <p className="lg:w-32 text-center poppins-black">
                      {otherMopSummaryData?.reduce((acc, total) => {
                        return acc + total.other_mop_amount;
                      }, 0)}
                    </p>
...
export default ModalOtherMopCashier;
